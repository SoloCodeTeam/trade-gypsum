    ...
    return(
        <div className="Second" id="2">
           <div>
                <h1>{t("Second.0")}</h1>
                <p>{t("Second.1")}</p>
                <button onClick={() => {modal.current.style.top = "20%";overlay.current.style.display = "block"}}>{t("Second.2")}</button>
           </div>
            ...
            <div ref={overlay} onClick={() => {modal.current.style.top = "100%";overlay.current.style.display = "none"}} className="overlay"></div>
        </div>
    )
}