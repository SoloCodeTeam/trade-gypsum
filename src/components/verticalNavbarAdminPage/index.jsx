...
export function VerticalNavbarAdminPage() {
    ...
    return(
		...
		<a className="flex items-center w-full px-3 mt-3" href="#">
			<img className="w-10 h-10" src="https://res.cloudinary.com/ds9evspym/image/upload/v1703694765/BNBM%20trade-gypsum/logo_fppag4.png" alt="logo" />
		...
		<div className="w-full px-2">
			<div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
				<a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					...
					<span className="ml-2 text-sm font-medium">{t("Admin.0")}</span>
				</a>
				<a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
					</svg>
					<span className="ml-2 text-sm font-medium">{t("Admin.1")}</span>
				</a>
				<a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700  rounded" href="#">
					<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
					</svg>
					<span className="ml-2 text-sm font-medium">{t("Admin.2")}</span>
				</a>
				<a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2" />
					</svg>
					<span className="ml-2 text-sm font-medium">{t("Admin.3")}</span>
				</a>
			</div>
			<div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<a className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					...
					<span className="ml-2 text-sm font-medium">{t("Admin.4")}</span>
		...
		<div className="flex flex-col items-center justify-center w-full h-17 mt-auto bg-indigo-800 hover:bg-indigo-700">
			...
			<a className="flex items-center w-full h-12 px-3 rounded hover:bg-indigo-700" href="#">
				...
				<span className="ml-2 text-sm font-medium">{t("Admin.5")}</span>
			</a>
		</div>
	</div>
{/* //////// */}
